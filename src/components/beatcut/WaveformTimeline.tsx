...
import { formatTime, formatTimeShort } from '../../utils/beatTime';
...
export const WaveformTimeline: React.FC<WaveformTimelineProps> = ({
  ...
  return (
    <div
      className="flex-1 flex flex-col min-h-0 bg-[#0c0d12] overflow-hidden focus:outline-none"
      onKeyDown={handleKeyDown}
      tabIndex={0}
      onMouseUp={handleMouseUp}
    >
      {/* Control Header for Timeline & Beat Density */}
      <div className="h-12 bg-[#141721] border-b border-[#262c3f] px-4 flex items-center justify-between shrink-0 select-none">
        {/* Beat Density Slider */}
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="w-36 h-2 rounded-lg bg-[#1a1e2d] cursor-pointer accent-blue-500"
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-mono bg-[#1a1e2d] px-2 py-0.5 rounded border border-[#262c3f] text-slate-300">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 bg-purple-600/20 hover:bg-purple-600/30 text-purple-300 border border-purple-500/40 rounded-lg text-xs font-medium transition cursor-pointer"
          ...
          {selectedMarkerId && (
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1 bg-red-600/20 hover:bg-red-600/30 text-red-400 border border-red-500/40 rounded-lg text-xs font-medium transition cursor-pointer"
          ...
          <button
            ...
            disabled={zoom <= 1.0}
            className="p-1 text-slate-400 hover:text-white disabled:opacity-30 rounded hover:bg-[#1a1e2d] transition"
          ...
          <button
            ...
            className="p-1 text-slate-400 hover:text-white rounded hover:bg-[#1a1e2d] transition ml-1"
      ...
      <div
        ...
        className="flex-1 relative overflow-x-auto overflow-y-hidden cursor-crosshair select-none bg-[#0c0d12]"
      >
        <canvas
          ref={canvasRef}
        ...
        {hoveredMarker && mousePos && (
          <div
            className="fixed pointer-events-none z-50 bg-[#141721]/95 backdrop-blur-md border border-[#262c3f] text-white text-xs px-2.5 py-1.5 rounded-lg shadow-xl shadow-black/50 space-y-0.5 transform -translate-x-1/2 -translate-y-full"
          ...
          >
            ...
            <div className="text-[11px] text-slate-300 font-mono">
              Thời gian: {formatTime(hoveredMarker.time)} ({hoveredMarker.time.toFixed(2)}s)
            </div>
          </div>
        )}
      </div>
      ...
      <div className="h-8 bg-[#141721] border-t border-[#262c3f] px-4 flex items-center justify-between text-[11px] text-slate-400 select-none shrink-0">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1 rounded-md border text-xs font-medium transition cursor-pointer ${
              showStrong && !isHideAll
                ...
                : 'bg-[#1a1e2d] border-[#262c3f]/60 text-slate-500 line-through opacity-50 hover:opacity-80'
            }`}
            title="Nhấp để Ẩn / Hiện nhịp mạnh"
          >
          ...
          <button
            ...
            title="Nhấp để Ẩn / Hiện nhịp chuẩn"
          >
          ...
          <div className="h-3.5 w-px bg-[#262c3f] mx-1" />
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1 rounded-md border text-xs font-semibold transition cursor-pointer ${
              isHideAll
                ...
                : 'bg-[#1a1e2d] hover:bg-slate-700 border-[#262c3f] text-slate-300 hover:text-white'
            }`}
