...
export const BottomPlayer: React.FC<BottomPlayerProps> = ({
  ...
  return (
    <footer className="h-16 bg-[#141721] border-t border-[#262c3f] px-6 flex items-center justify-between select-none z-20 shrink-0">
      {/* Left: Time display */}
      ...
      <div className="flex-1 max-w-2xl px-6 flex flex-col items-center gap-1.5">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={disabled}
            className="p-1.5 text-slate-400 hover:text-slate-100 hover:bg-[#1a1e2d] disabled:opacity-30 rounded-lg transition"
        ...
        <div className="w-full flex items-center gap-2">
          <input
            ...
            className="w-full h-1.5 bg-[#1a1e2d] rounded-lg cursor-pointer accent-blue-500"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 min-w-[200px] justify-end">
        ...
        <div className="flex items-center gap-1 bg-[#1a1e2d] px-2 py-1 rounded-lg border border-[#262c3f]">
          ...
          >
            {speeds.map((s) => (
              <option key={s} value={s} className="bg-[#141721] text-slate-200">
                {s}x
              </option>
            ))}
          </select>
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            disabled={disabled}
            className="w-20 h-1.5 bg-[#1a1e2d] rounded-lg cursor-pointer accent-blue-500"
