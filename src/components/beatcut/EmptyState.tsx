...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 select-none bg-[#0c0d12]">
      <input
        type="file"
        ref={fileInputRef}
      ...
      <div
        ...
        className={`w-full max-w-xl p-10 rounded-2xl border-2 border-dashed transition flex flex-col items-center justify-center text-center cursor-pointer group ${
          isDragOver
            ...
            : 'border-[#262c3f] hover:border-blue-500/50 bg-[#141721]/60 hover:bg-[#1a1e2d]/50'
        }`}
      >
        ...
        <p className="text-xs text-slate-400 max-w-md mb-6 leading-relaxed">
          ...
          Hệ thống sẽ tự động tạo dạng sóng và hỗ trợ phân tích nhịp bằng AI Librosa & Web Audio API.
        </p>
        ...
        <button
          ...
          className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 active:scale-95 text-white text-xs font-semibold rounded-xl shadow-lg shadow-blue-600/25 transition flex items-center gap-2 cursor-pointer"
        >
